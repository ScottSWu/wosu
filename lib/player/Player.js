...
WOsu.Player.prototype.loadThreeGameplay = function (threeResync) {
    ...
    var materials = {
        ...
        sliderFollow: new THREE.ShaderMaterial({
            ...
            vertexShader: WOsu.Player.sliderFollowShader.vertexShader,
            fragmentShader: WOsu.Player.sliderFollowShader.fragmentShader,
        ...
        sliderBall: new THREE.ShaderMaterial({
            ...
            vertexShader: WOsu.Player.sliderBallShader.vertexShader,
            fragmentShader: WOsu.Player.sliderBallShader.fragmentShader,
...
*/
WOsu.Player.sliderFollowShader = {
    vertexShader: [
        // The current time of the playback
        "uniform float currentTime;",
...
*/
WOsu.Player.sliderRepeatShader = {
    vertexShader: [
        // The current time of the playback
        "uniform float currentTime;",
...
WOsu.Player.prototype.createThree_score = function (params) {
...
WOsu.Player.prototype.createThree_approach = function (params) {
    var obj = params.object;
    var x = obj.x - 256;
    var y = 192 - obj.y;
    var z = params.z;
...
WOsu.Player.prototype.createThree_circle = function (params) {
    var obj = params.object;
    var x = obj.x - 256;
    var y = 192 - obj.y;
    var z = params.z;
...
WOsu.Player.prototype.createThree_sliderStart = function (params) {
    var obj = params.object;
    var x = obj.x - 256;
    var y = 192 - obj.y;
    var z = params.z;
...
WOsu.Player.prototype.createThree_sliderEnd = function (params) {
    var obj = params.object;
    var x = obj.endX - 256;
    var y = 192 - obj.endY;
    var z = params.z;
...
WOsu.Player.prototype.createThree_sliderBody = function (params) {
    var obj = params.object;
    var z = params.z;
    var s = params.mechanics.CS;
    var colors = params.mechanics.colors;
...
WOsu.Player.prototype.createThree_sliderBall = function (params) {
    var obj = params.object;
    var x = obj.x - 256;
    var y = 192 - obj.y;
    var z = params.z;
...
WOsu.Player.prototype.createThree_sliderFollow = function (params) {
    var obj = params.object;
    var x = obj.x - 256;
    var y = 192 - obj.y;
    var z = params.z;
...
WOsu.Player.prototype.createThree_spinner = function (params) {
    var obj = params.object;
    var z = params.z;
